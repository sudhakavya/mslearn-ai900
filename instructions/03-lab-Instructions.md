...
3.  Open the file **03 - Object Detection.ipynb** notebook in Visual Studio Code.

4.  In this lab we will be using the Custom Vision service in Azure to identify multiple real-world items in one image.
