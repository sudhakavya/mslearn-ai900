...
3.  Open the file **02 - Image Classification.ipynb** notebook in Visual Studio Code.

4.  In this lab we will be using the Custom Vision service in Azure to identify one real-world item in an image.
