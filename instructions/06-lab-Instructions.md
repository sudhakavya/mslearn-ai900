...
3.  Open the file **06 - Receipts with Form Recognizer.ipynb** notebook in Visual Studio Code.

4.  In this lab we will be using the Form Recognizer service in Azure to identify text on from images of forms.
